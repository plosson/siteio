...
export class McpHandler {
  ...
  private getStartedText(grant: ShareGrant, ctx: McpHostCtx, bearer: string): string {
    ...
    return [
      ...
      "",
      "   1. Install (once), for your OS:",
      "      macOS / Linux:        curl -LsSf https://siteio.houlahop.com/install | sh",
      "      Windows (PowerShell): iwr -useb https://siteio.houlahop.com/install.ps1 | iex",
